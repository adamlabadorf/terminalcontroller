...
# bg colors
def bg_black(str) :
	return colorize(str,'bg_black')
def bg_blue(str) :
	return colorize(str,'bg_blue')
def bg_green(str) :
	return colorize(str,'bg_green')
def bg_cyan(str) :
	return colorize(str,'bg_cyan')
def bg_red(str) :
	return colorize(str,'bg_red')
def bg_magenta(str) :
	return colorize(str,'bg_magenta')
def bg_yellow(str) :
	return colorize(str,'bg_yellow')
def bg_white(str) :
	return colorize(str,'bg_white')
...
def test() :
	...
	sys.stdout.write(colorize('Blinking text\n','blink'))
	sys.stdout.write(colorize('Dimmed text\n','dim'))
	sys.stdout.write(colorize('Reverse text\n','reverse'))
